  ...
  try {
    ...
    const updatedHomemaid = await prisma.homemaid.update({
      ...
      data: {
        ...
        PassportStart,
        PassportEnd,
        ArabicLanguageLevel: ArabicLanguageLevel ?? ArabicLanguageLeveL,
        EnglishLanguageLevel,
        Salary,
        LaundryLevel: LaundryLevel ?? laundryLevel,
        washingLevel: washingLevel ?? laundryLevel ?? LaundryLevel,
        IroningLevel: IroningLevel ?? ironingLevel,
        CleaningLevel: CleaningLevel ?? cleaningLevel,
        CookingLevel: CookingLevel ?? cookingLevel,
        SewingLevel: SewingLevel ?? sewingLevel,
        BabySitterLevel: BabySitterLevel ?? childcareLevel,
        childcareLevel: childcareLevel ?? BabySitterLevel,
        elderlycareLevel,
        Education,
      }
    });
