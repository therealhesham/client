...
import { Star, Award, ThumbsUp, ShieldCheck, TrendingUp, Sparkles, Heart } from 'lucide-react';
...
export default function HomeClient({ initialBanner = "/banner.png", initialBorder = true, initialStats = null }: { initialBanner?: string; initialBorder?: boolean; initialStats?: any }) {
  const heroVariants = {
  ...
  const [heroBanner, setHeroBanner] = useState(initialBanner);
  const [showBannerBorder, setShowBannerBorder] = useState(initialBorder);
  const [statsData, setStatsData] = useState<any>(initialStats || DEFAULT_STATS);

  useEffect(() => {
    if (initialBanner) setHeroBanner(initialBanner);
    if (initialBorder !== undefined) setShowBannerBorder(initialBorder);
    if (initialStats) setStatsData(initialStats);
  }, [initialBanner, initialBorder, initialStats]);
  ...
  useEffect(() => {
    const fetchSettings = async () => {
      try {
        ...
        if (res.data) {
          if (res.data.heroBannerUrl) setHeroBanner(res.data.heroBannerUrl);
          if (res.data.showBorder !== undefined) setShowBannerBorder(res.data.showBorder);
  ...
  const toggleModal = () => {
    ...
    const IconComponent = CustomIcon || STAT_ICONS[iconName] || STAT_ICONS.users || Users;

    useEffect(() => {
      const totalUpdates = 40;
      const stepTime = 150;
      const increment = Math.ceil(target / totalUpdates) || 1;
    ...
    if (highlightWord && !formattedLabel.includes("<span>") && !formattedLabel.includes("<span")) {
    ...
    return (
      <div className="flex-1 bg-white/95 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-[#ECC383]/40 text-center min-w-48 flex flex-col items-center">
        ...
        <div className="relative w-full h-24 mb-4 flex items-center justify-center">
          ...
          >
            <span className="text-5xl md:text-6xl font-extrabold text-[#003749] leading-none" dir="ltr">
        ...
        <div className="flex items-center justify-center gap-2 mb-3">
          <IconComponent className="w-6 h-6 text-[#ECC383] flex-shrink-0" />
          <p
          ...
          >
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20 text-right">
              ...
              <div className="lg:w-1/2 space-y-8 order-2 lg:order-1">
                ...
                <div className="text-lg md:text-xl text-white/95 leading-relaxed font-medium h-20 flex items-center">
                  <TextType
                    text={[
                ...
                >
                  <img
                    ...
                    className={`w-full max-w-md mx-auto rounded-3xl object-cover ${
                      showBannerBorder ? 'shadow-2xl border-4 border-[#ECC383]/40' : ''
                    }`}
                    onError={(e) => {
            ...
            {statsData?.showSection !== false && (
              ...
              >
                <h3 className="text-3xl font-bold text-[#003749] mb-12 text-center bg-gradient-to-r from-[#003749] to-[#025669] bg-clip-text text-transparent">
                  {statsData?.sectionTitle || "إحصائياتنا"}
                </h3>
              ...
              <g>
                <defs>
                  <linearGradient gradientUnits="userSpaceOnUse" gradientTransform="rotate(-44.63 1218.895 384.908)" y2="1241.89" x2="19.18" y1="822.21" x1="219.67" id="88813891-03a3-4b21-b9de-350d692e4d8b_comp-lvv1tkks">
                    <stop stopColor="#6ac578" offset="0"></stop>
                    <stop stopColor="#4a974d" offset=".88"></stop>
                  </linearGradient>
                  ...
                  <clipPath id="5b259977-09c9-49d8-9da6-6cc71cd8e613_comp-lvv1tkks">
                    <path strokeWidth="0" d="M2505.79 1017.01v786.87H422.56v-786.87h2083.23z"></path>
                  </clipPath>
                </defs>
                <g>
                  ...
                  <g clipPath="url(#5b259977-09c9-49d8-9da6-6cc71cd8e613_comp-lvv1tkks)">
              ...
              <g>
                <defs>
                  <clipPath id="612c8804-987d-4051-8404-01d259758f45_comp-lvv1zk8f">
                    <path d="M557.94 279.69v223.08H-20.21V279.69h578.15z" strokeWidth="0"></path>
                  </clipPath>
                  <clipPath id="f3594511-8ccc-4eca-88a6-743e9ba46813_comp-lvv1zk8f">
                    <path d="M203.97 394.91c0 18.678-15.142 33.82-33.82 33.82s-33.82-15.142-33.82-33.82 15.142-33.82 33.82-33.82 33.82 15.142 33.82 33.82z" strokeWidth="0"></path>
                  </clipPath>
                  <clipPath id="7818943c-ae56-40f9-a74c-6ff7f8c5c418_comp-lvv1zk8f">
                    <path d="M168.94 239.35c0 26.272-21.298 47.57-47.57 47.57-26.272 0-47.57-21.298-47.57-47.57 0-26.272 21.298-47.57 47.57-47.57 26.272 0 47.57 21.298 47.57 47.57z" strokeWidth="0"></path>
                  </clipPath>
                  <clipPath id="7584406e-f9fe-4473-86b7-70c400012328_comp-lvv1zk8f">
                    <path d="M203.97 92.04c0 18.678-15.142 33.82-33.82 33.82s-33.82-15.142-33.82-33.82 15.142-33.82 33.82-33.82 33.82 15.142 33.82 33.82z" strokeWidth="0"></path>
                  </clipPath>
                  <linearGradient id="ec4eb141-f9df-4918-8336-34060d5639ed_comp-lvv1zk8f" x1="-475.23" y1="254.58" x2="-531.9" y2="373.22" gradientTransform="rotate(-44.63 -31.012 -365.1)" gradientUnits="userSpaceOnUse">
                    <stop offset="0" stopColor="#6ac578"></stop>
                    <stop offset=".88" stopColor="#4a974d"></stop>
                  </linearGradient>
                ...
                <g style={{ isolation: 'isolate' }}>
                  ...
                  <g clipPath="url(#612c8804-987d-4051-8404-01d259758f45_comp-lvv1zk8f)">
                  ...
                  <g clipPath="url(#f3594511-8ccc-4eca-88a6-743e9ba46813_comp-lvv1zk8f)">
                    ...
                    <path fill="none" strokeLinejoin="round" strokeLinecap="round" strokeWidth=".48" stroke="#b74162" d="M174.26 414.88s1.01 1.7 1.44 3.24c.96 3.46 2.1 10.02 2.07 11.83"></path>
                  ...
                  <g clipPath="url(#7818943c-ae56-40f9-a74c-6ff7f8c5c418_comp-lvv1zk8f)">
                  ...
                  <g clipPath="url(#7584406e-f9fe-4473-86b7-70c400012328_comp-lvv1zk8f)">
                    ...
                    <path strokeWidth=".96" stroke="#e6e7e8" fill="none" strokeLinejoin="round" strokeLinecap="round" d="M170.49 115.67c.46 2.7.34 5.49-.35 8.14"></path>
                    <path strokeWidth=".96" stroke="#e6e7e8" fill="none" strokeLinejoin="round" strokeLinecap="round" d="M172.71 115.33c.19 3.14.3 6.28.35 9.42"></path>
                  </g>
              ...
              <g>
                <defs>
                  <linearGradient gradientUnits="userSpaceOnUse" gradientTransform="rotate(-44.63 -31.012 -365.1)" y2="375.08" x2="-523.9" y1="276.6" x1="-476.85" id="2f0c0650-6e80-41f4-80b5-97ef745b92ec_comp-lvv1tkky">
                    <stop stopColor="#8bc47c" offset="0"></stop>
                    <stop stopColor="#679653" offset=".88"></stop>
                  </linearGradient>
                  ...
                  <clipPath id="311e2004-70b0-4733-925d-d4913636a2c8_comp-lvv1tkky">
                    <path strokeWidth="0" d="M499.27 315.35V500H10.4V315.35h488.87z"></path>
                  </clipPath>
                </defs>
                <g>
                  ...
                  <g clipPath="url(#311e2004-70b0-4733-925d-d4913636a2c8_comp-lvv1tkky)">
                  ...
                  <path strokeMiterlimit="10" fill="none" stroke="#dfc184" strokeWidth="6" d="M258.01 139.75v12.26"></path>
                  <path strokeMiterlimit="10" fill="none" stroke="#dfc184" strokeWidth="6" d="m197.24 156.04 6.13 10.61"></path>
                  <path strokeMiterlimit="10" fill="none" stroke="#dfc184" strokeWidth="6" d="m152.75 200.53 10.61 6.12"></path>
                  <path strokeMiterlimit="10" fill="none" stroke="#dfc184" strokeWidth="6" d="M136.47 261.3h12.25"></path>
                  <path strokeMiterlimit="10" fill="none" stroke="#dfc184" strokeWidth="6" d="m152.75 322.07 10.61-6.13"></path>
                  <path strokeMiterlimit="10" fill="none" stroke="#dfc184" strokeWidth="6" d="m197.24 366.56 6.13-10.61"></path>
                  <path strokeMiterlimit="10" fill="none" stroke="#dfc184" strokeWidth="6" d="M258.01 382.85v-12.26"></path>
                  <path strokeMiterlimit="10" fill="none" stroke="#dfc184" strokeWidth="6" d="m318.79 366.56-6.13-10.61"></path>
                  <path strokeMiterlimit="10" fill="none" stroke="#dfc184" strokeWidth="6" d="m363.28 322.07-10.62-6.13"></path>
                  <path strokeMiterlimit="10" fill="none" stroke="#dfc184" strokeWidth="6" d="M379.56 261.3h-12.25"></path>
                  <path strokeMiterlimit="10" fill="none" stroke="#dfc184" strokeWidth="6" d="m363.28 200.53-10.62 6.12"></path>
                  <path strokeMiterlimit="10" fill="none" stroke="#dfc184" strokeWidth="6" d="m318.79 156.04-6.13 10.61"></path>
                  ...
                  <path stroke="#cccccc" strokeWidth=".5" strokeMiterlimit="10" fill="none" d="m106.08 356.58-22.54 3.06-1.68-23.87 23.45-1.65.77 22.46z"></path>
                  <path stroke="#cccccc" strokeWidth=".5" strokeMiterlimit="10" fill="none" d="m136.23 355.95-23.45 1.64-1.79-25.5 23.57-.02 1.67 23.88z"></path>
                  <path stroke="#cccccc" strokeWidth=".5" strokeMiterlimit="10" fill="none" d="m164.56 352.31-22.53 3.23-1.68-23.87 23.45-1.65.76 22.29z"></path>
                  <path stroke="#cccccc" strokeWidth=".5" strokeMiterlimit="10" fill="none" d="m109.3 391.01-23.53.44-1.68-23.88 23.45-1.64 1.76 25.08z"></path>
                  <path stroke="#cccccc" strokeWidth=".5" strokeMiterlimit="10" fill="none" d="m138.46 387.75-23.33 3.38-1.79-25.61 23.36-2.86 1.76 25.09z"></path>
                  <path stroke="#cccccc" strokeWidth=".5" strokeMiterlimit="10" fill="none" d="m167.83 387.43-23.57-.08-1.68-23.88 23.45-1.64 1.8 25.6z"></path>
                  <path stroke="#cccccc" strokeWidth=".5" strokeMiterlimit="10" fill="none" d="M111.44 421.61 88 423.25l-1.73-24.67 23.5-.84 1.67 23.87z"></path>
                  <path stroke="#cccccc" strokeWidth=".5" strokeMiterlimit="10" fill="none" d="m192.36 328.022 1.674 23.872-23.442 1.643-1.674-23.871 23.443-1.644z"></path>
                  <path stroke="#cccccc" strokeWidth=".5" strokeMiterlimit="10" fill="none" d="m194.59 359.828 1.673 23.872-23.442 1.643-1.674-23.871 23.443-1.644z"></path>
                  <path stroke="#cccccc" strokeWidth=".5" strokeMiterlimit="10" fill="none" d="m198.5 415.5-23.44 1.65-.82-25.44 22.59-.08 1.67 23.87z"></path>
                  <path stroke="#cccccc" strokeWidth=".5" strokeMiterlimit="10" fill="none" d="m140.69 419.56-24.75-.66-.37-21.57 23.45-1.64 1.67 23.87z"></path>
                  <path stroke="#cccccc" strokeWidth=".5" strokeMiterlimit="10" fill="none" d="m169.93 417.51-23.44 1.64-1.68-23.87 23.39-2.45 1.73 24.68z"></path>
              ...
              <g>
                <defs>
                  ...
                  <clipPath id="9a80cc4c-8891-454a-9189-d729758c201b_comp-lvv1tkko">
                    <path strokeWidth="0" d="M658.86 247.9v207.47H109.59V247.9h549.27z"></path>
                  </clipPath>
                </defs>
                <g style={{ isolation: 'isolate' }}>
                  ...
                  <g clipPath="url(#9a80cc4c-8891-454a-9189-d729758c201b_comp-lvv1tkko)">
                  ...
                  <path stroke="#302d32" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.13" fill="none" d="M66.39 454.87h617.22"></path>
                </g>
              </g>
            </svg>
              ...
              <g>
                <defs>
                  ...
                  <clipPath id="8945d82a-e660-4974-895e-49b829f82145_comp-lvv1tkkj">
                    <path strokeWidth="0" d="M530.14 293.48V500H-16.63V293.48h546.77z"></path>
                  </clipPath>
                </defs>
                <g style={{ isolation: "isolate" }}>
                  ...
                  <g clipPath="url(#8945d82a-e660-4974-895e-49b829f82145_comp-lvv1tkkj)">
              ...
              <g>
                <defs>
                  ...
                  <clipPath id="8c603c05-a57f-4a91-99e2-fa23d851fce3_comp-lvv1tkl2">
                    <path strokeWidth="0" d="M503.77 311.21V500H3.95V311.21h499.82z"></path>
                  </clipPath>
                </defs>
                <g style={{ isolation: "isolate" }}>
                  ...
                  <g clipPath="url(#8c603c05-a57f-4a91-99e2-fa23d851fce3_comp-lvv1tkl2)">
                  ...
                  <g>
                    ...
                    <path d="M322.81 102h-91.17c-1.86 0-3.37 1.51-3.37 3.37v35.75a3.36 3.36 0 0 0 3.36 3.36h72.02l13.05 10.1c1.65 1.28 4.04.1 4.04-1.98v-8.12h2.05c1.86 0 3.37-1.51 3.37-3.37v-35.75c0-1.86-1.51-3.37-3.37-3.37Z" fill="none" stroke="#ddbf82" strokeMiterlimit="10"></path>
                    <path d="M318.25 155.62c-.65 0-1.3-.21-1.84-.63l-12.92-10h-71.85c-2.13 0-3.87-1.73-3.87-3.87v-35.75c0-2.13 1.73-3.87 3.87-3.87h91.17c2.13 0 3.87 1.73 3.87 3.87v35.75c0 2.13-1.73 3.87-3.87 3.87h-1.55v7.62c0 1.16-.65 2.19-1.68 2.7-.42.21-.88.31-1.33.31Zm-86.61-53.12c-1.58 0-2.87 1.29-2.87 2.87v35.75c0 1.58 1.29 2.87 2.87 2.87h72.2l13.19 10.21c.62.48 1.41.56 2.11.22.7-.35 1.12-1.02 1.12-1.8V144h2.55c1.58 0 2.87-1.29 2.87-2.87v-35.75c0-1.58-1.29-2.87-2.87-2.87h-91.17Z" fill="none" stroke="#ddbf82" strokeMiterlimit="10"></path>
