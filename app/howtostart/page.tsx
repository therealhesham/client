          ...
          <div className="flex flex-row bg-white p-3 rounded-2xl max-h-[900px]">
            ...
            <div className="flex flex-col">
              <h3
                ...
                style={{ color: "rgb(1, 55, 73)", direction: "ltr", textAlign: "right" }}
              >
                أفضل تجربة استقدام
              </h3>
              <div>
                <h3
                  className={`${sectionFonts.className} m-[9px] text-xl`}
                  style={{ color: "rgb(1, 55, 73)", direction: "ltr", textAlign: "right" }}
                >
                  مساند هي إحدى المبادرات التابعة لوزارة الموارد البشرية والتنمية الاجتماعية، إنها منصة إلكترونية شاملة
                  لتجربة استقدام العمالة المنزلية بطريقة متكاملة تهدف إلى تسهيل إجراءات استقدام العمالة المنزلية وزيادة
                  مستوى الحفاظ على حقوق جميع الأطراف من خلال تعريف أصحاب العمل والعمالة المنزلية بحقوقهم وواجباتهم
                </h3>
              </div>
            </div>
            <svg
              ...
              width="420"
              data-bbox="23.22 7.83 465.56 475.29"
              viewBox="0 0 512 512"
            ...
            >
              <g>
                <defs>
                  ...
                  <mask maskUnits="userSpaceOnUse" height="457.42" width="433.99" y="-237.49" x="-154.99" id="5dba708f-3a06-49ef-ba4f-e09f4a401a14"></mask>
                  ...
                  <mask maskUnits="userSpaceOnUse" height="308.32" width="436.26" y="-290.27" x="-154.03" id="d771c4ed-1f10-4cMarkers: none;"></mask>
                ...
                <path
                  d="m238.35 16.58-.02.05-3.36 1.48 23.44 10.24 85.23 37.07 19.3-11.5v-.15l-19.18-8.4-62.04-27.17.08-.03-23.54-10.31h-.04l-.09-.03-19.78 8.74Z"
                  fill-rule="evenodd"
                  fill="#b3b2b3"
                ></path>
                ...
                <path
                  d="m343.75 65.16-84.77-36.54h-.01l84.9 36.75v25.64h19.08V53.82l-19.2 11.33Z"
                  fill="#59aac7"
                  fill-rule="evenodd"
                ></path>
                ...
                <g mask="url(#14a1d04b-e012-4359-a565-5cee3e945833_comp-lw4qtv43)">
                  <path
                    d="m343.81 45.04-61.7-27.01-23.19 10.09 84.77 36.85 19.19-11.43v-.16l-19.07-8.35Z"
                    fill="none"
                  ></path>
                </g>
                ...
                <path
                  fill="#59aac7"
                  fill-rule="evenodd"
                  d="m245.8 33.31 13.16-5.71-23.35-10.17-77.43 33.98.07 20.41 87.55-38.51z"
                ></path>
                <path
                  d="M326.15 140.56v-1.49l-.04-.04-.02-.02h-46.86l-18.33 18.8h-.69l-.06 27.44v15.74h-.05v.04h-83.01v18.75h83.27v.65H177V201.7h-.07L177 89.64h.05V64.1h-.03v-.29l-4.99 2.47-13.59 5.9V73l-.24.12.09 128.61 18.55 18.85h83.74l-.08-.07v-.73h.09v.15l.09.07 19.11 14.98v-15.05h44.8v.65h.02l19.17-19.08v-43.78l-17.6-17.17Zm-47.42 17.64h-.09v-.02h.09v.02Zm45.82 42.83h-44.8v-42.79l9.6.01v-.05h-10.62v-.02l45.81-.06v42.92Z"
                  fill="#59aac7"
                  fill-rule="evenodd"
                ></path>
                <path
                  d="M33.22 253.7-10 3.11H484.5l4.28-3.11H33.22z"
                  fill="#59aac7"
                  fill-rule="evenodd"
                ></path>
                <path
                  d="M165.91 322.87h-12.18v62.87H90.28v-6.82c-.05-9.63.21-19.29-.23-28.9-.03-.59-.08-1.15-.13-1.72-.03-.3-.04-.62-.07-.92-.01-.12-.04-.24-.05-.37-.39-3.31-1.17-6.36-2.34-9.09-3.33-7.79-9.75-12.99-18.83-14.19-10.93-1.45-22.2-.3-33.5-.3v10.2c7.65 0 14.94-.16 22.24.04 5.95.17 10.92 1.47 14.33 4.06 1.87 1.41 3.27 3.21 4.11 5.42.01.03.03.06.04.09.08.22.14.46.21.69.07.24.16.46.22.71l.03.13c.11.44.2.9.26 1.37 1.81 12.98 1.68 26.23 2.41 40.02H23.22v10.69h142.7v-73.96Z"
                  fill="#59aac7"
                  fill-rule="evenodd"
                ></path>
                <path
                  d="M470.79 324.79c-15.01-4.64-30.44-1.69-46.3-2.33v63.1h-61.14V322.7h-12.42v62.91h-27.05v-57.54h-12.49v57.46h-27.58v-57.42h-12v57.81c-10.02 0-46.09.04-55.51-.01-11.23-.05-13.9-2.74-13.91-14.08-.03-26.44 0-52.87 0-79.32v-6.05h-12.37v5c0 25.86-.08 51.72.02 77.58.09 22.33 5.97 28.15 28.16 28.15h270.3c0-17.29.79-34.04-.29-50.66-.66-10.36-7.03-18.53-17.42-21.74Zm6.14 60.86h-39.96v-51.62c7.8 0 15.7-.72 23.4.18 9.96 1.16 15.91 7.75 16.43 17.88.56 10.93.12 21.92.12 33.57Z"
                  fill="#59aac7"
                  fill-rule="evenodd"
                ></path>
                <path
                  d="M154.61 312.15H165c.76 0 .87-.11.87-.87v-11.15c0-.76-.11-.87-.87-.87h-10.39c-.77 0-.87.11-.87.87v11.16c0 .76.1.87.87.87Z"
                  fill="#59aac7"
                  fill-rule="evenodd"
                ></path>
                <path
                  d="M153.35 475.96c-5.58 0-10.73.03-15.88 0-14.1-.09-18.84-4.75-18.94-18.84-.08-12.08-.01-24.15-.01-36.24v-3.84h-7.86c0 15.45-.58 30.65.18 45.78.64 12.62 7.75 19.19 20.39 19.91 9.87.56 19.78.13 29.67.11.17 0 .33-.29.44-.38v-65.37h-7.99v58.87Z"
                  fill="#59aac7"
                  fill-rule="evenodd"
                ></path>
                <path
                  d="M82.62 416.83c-2.46-.17-3.65.7-4.5 3.04-5.95 16.27-12.02 32.48-18.06 48.72-.64 1.74-1.36 3.44-2.3 5.81l-21.35-57.32H23.59v65.65h7.6v-56.3c.71.7 1.23 1.57 1.52 2.53 6.38 17.08 12.79 34.15 19.09 51.27.74 1.99 1.61 3.12 3.89 2.75 1.02-.17 2.07-.17 3.09 0 2.89.48 4.16-.82 5.12-3.49 6.03-16.6 12.22-33.14 18.39-49.69.43-1.16 1.01-2.26 1.52-3.38l.65.18v56.1h7.8v-65.82c-3.47 0-6.57.16-9.65-.05Z"
                  fill="#59aac7"
                  fill-rule="evenodd"
                ></path>
                <path
                  fill="#59aac7"
                  fill-rule="evenodd"
                  d="M378.62 474.28V454.7h39.43v-9.02h-39.37v-19.95h39.35v-8.32h-47.79v65.71h51.71v-8.84h-43.33z"
                ></path>
                <path
                  d="M465.92 417.73c-10.81-1.01-21.77-.21-32.89-.21v65.33c9.79 0 19.35.42 28.86-.1 14.17-.79 22.39-7.73 25.21-20.7 1.74-7.89 1.77-16.07.09-23.97-2.5-11.84-9.47-19.23-21.27-20.34Zm12.87 42.7c-1.36 9.94-8.06 14.74-20.11 15.41-5.83.32-11.7.05-17.84.05v-52.22c8.37.45 16.67.29 24.75 1.51 7.9 1.19 12.45 7.03 13.28 14.73.73 6.77.83 13.78-.09 20.51Z"
                  fill="#59aac7"
                  fill-rule="evenodd"
                ></path>
                <path
                  d="M346.37 470.59c-1.33-.95-2.03-1.98-2.71-3.02-10.49-16.06-20.96-32.13-31.5-48.15-.68-1.03-1.85-2.27-2.92-2.42-2.57-.36-5.24-.11-8.06-.11v65.88h7.44v-54.93c1.28 1.85 2.01 2.85 2.68 3.88 10.59 16.26 21.18 32.52 31.82 48.76.63.97 1.63 2.24 2.57 2.35 2.68.32 5.42.11 8.15.11v-65.88h-7.47v53.54Z"
                  fill="#59aac7"
                  fill-rule="evenodd"
                ></path>
                <path
                  d="M205.65 445.93c-3.91-.09-7.83.07-11.72-.23-5.69-.43-8.78-4.33-8.83-10.7-.06-6.27 3.07-10.28 8.78-10.71 4.24-.32 8.5-.19 12.75-.21 4.91-.03 9.83 0 14.89 0v-6.9c-9.91 0-19.67-.41-29.38.11-9.24.49-14.04 5.23-15.11 14.39-1.44 12.24 3.39 20.82 17.39 21.36 3.79.14 7.59 0 11.38.16 6.46.27 9.9 3.76 10.22 10.15.42 8.32-3.34 12.43-11.77 12.57-7.47.13-14.95.03-22.42.03h-3.6v6.77c10.47 0 20.82.55 31.08-.17 9.01-.63 13.67-5.5 14.78-14.1 1.55-12.12-2.42-22.14-18.43-22.52Z"
                  fill="#59aac7"
                  fill-rule="evenodd"
                ></path>
                <path
                  d="M268.19 424.44q-3.06-7.89-11.65-7.51c-.23 0-.44.09-.91.18l-25.56 65.85c2.07 0 3.68-.17 5.24.04 2.66.35 3.79-.77 4.55-3.28 1.19-3.94 3.01-7.69 4.23-11.61.66-2.11 1.76-2.54 3.74-2.51 8.38.09 16.77.11 25.16-.02 2.14-.04 3.05.78 3.7 2.66 1.44 4.23 2.99 8.42 4.65 12.57.35.87 1.33 1.96 2.13 2.05 2.3.27 4.67.1 7.32.1-.57-1.59-.93-2.67-1.34-3.72-7.08-18.27-14.16-36.53-21.25-54.79Zm-20.52 33.86 12.24-33.12h.8v.01l12.22 33.11h-25.26Z"
                  fill="#59aac7"
                  fill-rule="evenodd"
                ></path>
              </g>
